	...
	var page = {
		init:function(){
			...
			form.addEventListener('submit',function(e){
				if(!isSubmiting && this.check()){
                    ...
                    salePrice.value = Number(salePrice.value);
					isSubmiting = true;
					form.submit();
				}
			}.bind(this),false); 
			[title,summary,image,detail,price,salePrice].forEach(function(item){
		...
		check:function(){
			...
			[
                ...
                [salePrice,function(value){return value == '' || !Number(value)}]
