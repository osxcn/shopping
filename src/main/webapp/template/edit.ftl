...
<#include "include/header.ftl"><div class="g-doc">
    ...
    <#else>
    <div class="n-public">
        <form class="m-form m-form-ht" id="form" method="post" action="/content/editSubmit?id=${product.id}" onsubmit="return false;" autocomplete="off">
            <div class="fmitem">
            ...
            <div class="fmitem">
                ...
                <div class="fmipt">
                    <input class="u-ipt price" name="salePrice" value="${product.salePrice}"/>元
                </div>
            </div>
